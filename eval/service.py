...
SUPPORTED_MODELS = {
	...
	# 'mixtral-8x7b': {
	# 'provider': 'groq',
    # 'model_name': 'mixtral-8x7b',  # or 'llama3-70b-8192'
    # 'base_url': 'https://api.groq.com/openai/v1',
    # 'api_key_env': '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',
	# },
	...
	'gemma2-9b-it': {
		...
		'base_url': 'https://api.groq.com/openai/v1',
		'api_key_env' : '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',
